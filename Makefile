...
SRCEXT := cpp
OBJECTS1 := $(BUILDDIR)/client_main.o $(BUILDDIR)/im_session.o $(BUILDDIR)/im_client_user_io_handler.o $(BUILDDIR)/im_client.o
OBJECTS2 := $(BUILDDIR)/server_main.o $(BUILDDIR)/im_session.o $(BUILDDIR)/im_session_manager.o $(BUILDDIR)/im_message_handler.o $(BUILDDIR)/im_server.o
CFLAGS := -std=c++11
