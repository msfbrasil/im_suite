...
SRCEXT := cpp
OBJECTS1 := $(BUILDDIR)/client_main.o $(BUILDDIR)/im_session.o $(BUILDDIR)/im_client_user_io_handler.o $(BUILDDIR)/im_message_handler.o $(BUILDDIR)/im_message_publisher.o $(BUILDDIR)/im_client.o
